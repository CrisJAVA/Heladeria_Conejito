...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        // Inicializar CORE data (idempotente)
        inicializarNivelesFidelizacion();
        ...
        // Inicializar clientes ficticios si los niveles ya existen
    ...
    @Transactional
    public void inicializarNivelesFidelizacion() {
        if (nivelFidelizacionRepository.count() == 0) {
    ...
    @Transactional
    public void inicializarMetodosPago() {
    ...
    @Transactional
    public void inicializarMetodosEntrega() {
    ...
    @Transactional
    public void inicializarSeccionesLanding() {
        if (seccionLandingRepository.count() == 0) {
            for (Object[] s : new Object[][]{
                ...
                if (!seccionLandingRepository.existsBySectionKey((String) s[0])) {
