...
public class DataInitializer implements CommandLineRunner {
    ...
    private void inicializarFakeClientes() {
        if (nivelFidelizacionRepository.count() == 0) return;
    ...
    private void inicializarMetodosEntrega() {
    ...
    private void inicializarProductos() {
        if (productoRepository.count() == 0) {
            ...
            if (raspadillas != null) {
                guardarProducto(raspadillas, "Raspadilla de Lúcuma", "Sabor tradicional y cremoso", 5.00, 80, true, true,
                        img.apply("Raspadilla+Lucuma"));
    ...
    private void inicializarSeccionesLanding() {
