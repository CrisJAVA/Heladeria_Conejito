          ...
          {socialLinks.map((social, index) => (
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all">
                ...
                <button className="mt-6 w-full py-3 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-100 rounded-xl font-medium hover:border-gray-200 transition-colors">
                  Conectar →
                </button>
              </div>
            </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            <motion.button
              ...
              className="px-6 py-3 bg-gradient-to-r from-[#ff6b9d] to-[#ff8fab] text-white rounded-xl font-medium"
            >
              Seguir
            </motion.button>
          </div>
