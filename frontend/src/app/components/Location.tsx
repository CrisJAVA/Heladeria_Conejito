...
import { MapPin, Clock, Users, Sun, ExternalLink } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://maps.app.goo.gl/3XvjPHBN5K3zpoDd7", "_blank")}
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#ff6b9d] to-[#ff8fab] text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center gap-2"
            >
              <ExternalLink className="w-5 h-5" /> Cómo llegar
            </motion.button>
          </motion.div>
        </div>
      </div>
