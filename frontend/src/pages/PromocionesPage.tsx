...
import { ArrowLeft, IceCream, Gift, Clock, Users, Cake, BadgePercent, Sparkles, Coffee, Tag } from "lucide-react";
import Footer from "../app/components/Footer";
import { listarPromocionesActivas, type PromocionDTO } from "../services/promociones";

// El backend guarda el nombre del ícono en el campo "icono"; aquí se resuelve
// al componente visual correspondiente (el diseño de las tarjetas no cambia).
const ICONOS: Record<string, any> = {
  IceCream, Users, Clock, Cake, BadgePercent, Sparkles, Coffee, Tag, Gift,
};
