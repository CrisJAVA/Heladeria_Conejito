...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    // Simulación de envío — en producción conectar con backend o Formspree
      ...
      <main className="flex-grow pb-24">
        ...
        <section className="px-4 md:px-8 mt-12 max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
            <div>
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-1">Nombre <span className="text-red-400">*</span></label>
              <input
            ...
            <div>
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-1">Correo Electrónico <span className="text-red-400">*</span></label>
              <input
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:border-[#ff6b9d] focus:ring-1 focus:ring-[#ff6b9d] outline-none transition-all"
            ...
            <div>
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-1">Mensaje <span className="text-red-400">*</span></label>
              <textarea
            ...
            <button
              type="submit"
              disabled={sending}
              className="w-full bg-[#ff7e9d] text-[#761235] font-bold text-lg py-4 rounded-xl shadow-md active:scale-95 transition-transform hover:opacity-90 disabled:opacity-50"
            >
